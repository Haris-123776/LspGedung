<?php
    ...
    require 'dummy.php';
     ...
     $pilih_tempat = $reservasi[0][0];
     $pilih_harga = $reservasi[0][1];
     $catering = false;
     $durasi = '';
     $total_bayar = 0;
     $errors = [];
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $pilih_tempat = $_POST['reservasi'] ?? $reservasi[0][0];  

        // Mendapatkan harga mobil yang dipilih dari array berdasarkan nama mobil
        $pilih_harga = array_column($reservasi, 1, 0)[$pilih_tempat];  
        ...
        // Validasi: Nomor identitas harus berupa angka is_numerik untuk mengecek apakah inputan berupa angka
        ...
        // strlen = string lenght untuk menghitung jumlah karakter yang diinputkan pada input dengan name identitas
        ...
        if (isset($_POST['simpan'])) { // Mengecek apakah tombol "Simpan" telah ditekan
            ...
            $reservasi = $_POST['reservasi']; // Mengambil input jenis mobil yang dipilih dari form
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST">
                    ...
                    <select class="form-select mb-3" name="reservasi" onchange="this.form.submit()">
                        <?php foreach  ($reservasi as $indexarray => $nilai) { ?>
                            <option value="<?= $nilai[0] ?>" <?= ($nilai[0] === $pilih_tempat) ? 'selected' : '' ?>>
                                <?= $nilai[0] ?>
                            </option>
                        <?php }?>
                    </select>
